...
{
    public class SecretKeyAuthorizedAttribute : FilterAttribute, IAuthorizationFilter
    {
        ...
        private bool Authorize(HttpActionContext actionContext)
        {
            try
            {
                SessionStore.Set(Constants.KEY_SESSION_IS_SECRET_KEY, false);
                ...
                if (secret_key != null && secret_key == ConfigManager.StaticGet("API_SECRET_KEY"))
                {
                    ...
                    SessionStore.Set(Constants.KEY_SESSION_IS_SECRET_KEY, true);
                    return true;
                }
